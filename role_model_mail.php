...
<body>
    ...
    <form id="contact-form" action="role_model_send.php" method="POST" class="form-contact">
    <input type="hidden" name="user_id" value="<?= $_GET['user_id'] ?>">
        <fieldset>
            ...
            <label for="fullname">เลขที่แบบ</label><br>
            <input id="head" class="form-control" name="head" value="<?= $info['code'] ?>"><br>
            <label for="fullname">รายละเอียด</label><br>
            <input id="detail" class="form-control" name="detail" value="<?= $info['detail'] ?>">
            <br>
        </fieldset>
        <br>
        <fieldset>
            ...
            <div class="col-sm-6 py-2">
                <label for="message" class="fg-grey">ข้อความจากพนักงานกองช่าง</label>
                <textarea id="message" rows="6" cols="50" required class="form-control" name="message" laceholder="กรอกข้อความ"></textarea>
            </div>
            </fieldset><br>
        <div class="a"><a href="backoffice.php?page=model">ย้อนกลับ</a>&nbsp;
