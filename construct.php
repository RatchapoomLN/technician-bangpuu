...
<head>
    ...
    <title>ก่อสร้าง-รื้อถอนอาคาร</title>
</head>
...
<body>
            ...
            <div class="header">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <a href="construct.php?page=construct" class=" text-succes  fw-bold">แจ้งก่อสร้าง และรื้อถอนอาคาร</a>
    ...
    if (!isset($_GET['page']))
        $_GET['page'] = 'construct';
    if ($_GET['page'] == 'construct') { //manage user
        $sql = "SELECT * FROM construct ";
        $result = mysqli_query($link, $sql) or die(mysqli_error($link));
    ?>
        <h3 class="p-3">แจ้งเรื่องก่อสร้าง และ รื้อถอนอาคาร</h3>
        <form action="do_construct.php" method="post" enctype="multipart/form-data">
                ...
                <div class="col-3">
                    ...
                    <div class="form-group">
                        ...
                        <select name="inform" id="pre">
                            <option value="ก่อสร้างอาคาร">ก่อสร้างอาคาร</option>
                            <option value="รื้ถอนอาคาร">รื้อถอนอาคาร</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="details">หัวข้อ*</label><br>
                    ...
                    <div class="form-group">
                        <label for="address">สถานที่ใกล้เคียงจุดแจ้งเรื่อง*</label><br>
