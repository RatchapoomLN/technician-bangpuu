...
<body>
    ...
    <div class="all">
        <div class="title page">
            ...
            <label for="fullname">- กองช่างได้รับเรื่องก่อร้างและรื้อถอนอาคาร กรณีนี้จากเว็บไซต์ ของกองช่าง เมือวันที่</label>
            <?php
        ...
        if ($info['picture1'] != "") {
        ?>
            <img src="img/construct/<?= $info['picture1'] ?>" width="300">&nbsp;&nbsp;
        <?php
        }
        ?>
        ...
        if ($info['picture2'] != "") {
        ?>
            <img src="img/construct/<?= $info['picture2'] ?>" width="300">
        <?php
        }
        ?>
        <br>
        ...
        ?>
            <br><a id="hid" href="do_role_documents.php?user_id=<?= $info['user_id'] ?>" class="btn btn-outline-info">รับยื่นเรื่อง</a>&nbsp;&nbsp;
        <?php
        }
        ?>
