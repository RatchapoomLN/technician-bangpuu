...
<body>
    ...
    <div class="text">
        ...
        แจ้งเรื่อง : <?= $row['details'] ?>&nbsp;||&nbsp;<a href="backoffice.php?page=problem">ย้อนกลับ</a>&nbsp;||&nbsp;<a href="img/problem/video/<?=$row['video']?>" class="b" download>โหลดคลิป</a>

    <div class="video"><video  height="800" controls src="img/problem/video/<?=$row['video']?>"></div>
