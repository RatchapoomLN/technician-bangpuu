...
<body>
    ...
    <form id="contact-form" action="send.php" method="POST" class="form-contact" enctype="multipart/form-data">
        ...
        <fieldset>
            ...
            <div class="form-group">
                <label for="poto" class="fg-grey">ไฟล์รูปภาพ-หลังการแก้ไข</label><br>
            ...
            <div class="form-group">
                ...
                <textarea id="message" rows="6" cols="50" required class="form-control" name="message" placeholder="กรอกข้อความ"></textarea>
            </div>
        </fieldset><br>
        <div class="a"><a href="backoffice.php?page=problem">ย้อนกลับ</a>&nbsp;
            <!-- <button type="submit" name="sendmail" class="btn btn-primary"onclick="return confirm('ยืนยัน');">ส่ง E-mail</button> -->
            <input type="button" class="bott" id="btn-ok" value="ส่ง E-mail">
        </div>
    </form>
    <script>
