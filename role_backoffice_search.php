                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <td>
                                        ...
                                        if ($row['status'] == "0") {
                                        ?>
                                            <a href="do_role_status.php?user_id=<?= $row['user_id'] ?>" class="btn btn-outline-secondary">รับเรื่อง</a><br>
                                            <div class="pt-1"></div>
                                        <?php
                                        }
                                        ?>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            if ($row['status'] == "0") {
                            ?>
                                <a href="status_role_model.php?user_id=<?= $row['user_id'] ?>" class="btn btn-outline-secondary">รับทราบแล้ว</a><br>
                            <?php
                            }
                            ?>
                            <?php
