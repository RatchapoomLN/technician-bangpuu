...
<body>
            ...
            <div class="header">
                ...
                <div class="dropdownt">
                    ...
                    <div class="dropdown-content">
                        ...
                        <a href="taibanmai.php?page=taibanmai" class=" text-succes fw-bold">เขตตำบลท้ายบ้านใหม่</a>
    ...
    if (!isset($_GET['page']))
        $_GET['page'] = 'taibanmai';
    if ($_GET['page'] == 'taibanmai') { //manage user
        $sql = "SELECT * FROM taibanmai
                ORDER BY CONVERT (moo USING tis620)";
        $result = mysqli_query($link, $sql) or die(mysqli_error($link));
    ?><div class="p-3"></div>
        <p class="p">ผู้รับผิดชอบ เขตตำบลท้ายบ้านใหม่</p>
        <div class="p-1"></div>
                    ...
                    ?>
                        <tr>
                            <td>
                                ...
                                if ($row['picture'] != "") {
                                ?>
                                    <img src="img/taibanmai/<?= $row['picture'] ?>" width="130">
                                <?php
                                } else {
                                ?>
