...
<header>
            ...
            <div class="header">
                ...
                <div class="dropdownt">
                    ...
                    <div class="dropdown-content">
                        ...
                        <a href="bangpuumai.php?page=bangpuumai"class=" text-succes fw-bold">เขตตำบลบางปูใหม่</a>
                    </div>
                </div>
                <div class="dropdownt">
    <button class="dropbtn"onclick="location.href='search.php';">ค้นหาข้อมูลที่แจ้ง <i class='bx bx-search'style='font-size:24px'></i></button>
            ...
            include('config.php');
            if (!isset($_GET['page']))
            $_GET['page'] = 'bangpuumai';
            if ($_GET['page'] =='bangpuumai') { //manage user
                $sql = "SELECT * FROM bangpuumai
                ORDER BY CONVERT (moo USING tis620)";
            $result = mysqli_query($link,$sql) or die(mysqli_error($link));
            ?><div class="p-3"></div>
            <p class="p">ผู้รับผิดชอบ เขตตำบลบางปูใหม่</p><div class="p-1"></div>
                    ...
                    while ($row=mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            <td>
                                        ...
                                        if ($row['picture'] != "") {
                                        ?>
                                            <img src="img/bangpuumai/<?= $row['picture'] ?>" width="130">
                                        <?php
                                        } else {
                                        ?>
