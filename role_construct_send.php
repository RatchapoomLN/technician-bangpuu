...
include('config.php');
    ...
    $sql = "SELECT * FROM construct WHERE user_id='".$_POST['user_id']."' LIMIT 1";
    ...
    $(document).ready(function(){
      ...
      if ($uploadStatus == 1) {
        ...
        $htmlContent = '<h4>ผู้ใช้บริการ : '.$name.'</h4>'.
          ...
          'ข้อความจากพนักงานกองช่าง : '.$message.'</p>'.
          "
          ...
          "<br>
                ...
                <br>โดยสามารถทำการแจ้งปัญหาได้ที่หน้าเว็บไซต์ 
                <br>https://localhost/technician/main.php ตลอด 24 ชั่วโมง";
