...
<body>
        ...
        <nav class="navbar">
            <div class="header">
                ...
                <div class="dropdownt">
                    ...
                    <div class="dropdown-content">
                        <a href="taiban.php?page=taiban" class=" text-succes fw-bold">เขตตำบลท้ายบ้าน</a>
    ...
    if (!isset($_GET['page']))
        $_GET['page'] = 'taiban';
    if ($_GET['page'] == 'taiban') { //manage user
        $sql = "SELECT * FROM taiban
                ORDER BY CONVERT (moo USING tis620)";
        $result = mysqli_query($link, $sql) or die(mysqli_error($link));
    ?>
        <div class="p-3"></div>
        <p class="p">ผู้รับผิดชอบ เขตตำบลท้ายบ้าน</p>
        <div class="p-1"></div>
                    ...
                    ?>
                        <tr>
                            <td>
                                ...
                                if ($row['picture'] != "") {
                                ?>
                                    <img src="img/taiban/<?= $row['picture'] ?>" width="130">
                                <?php
                                } else {
                                ?>
